...
| الرمز | الوصف | الحالة |
|---|---|---|
| D-2 | الطابعة: الأصلي `strings.xml` يذكر **cp1251**، بينما app1 يستخدم **cp1256** | ⚠️ اختبار ميداني مطلوب على Datecs DPP-250 |
...
| **P3 (تحسينات/تأجيل)** | G-5, G-9, D-2 | متعدّد الفروع + تأكيدات + اختبار طابعة ميداني |
