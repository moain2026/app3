...
public class MenuOprationAdapter extends BaseViewAdapter<AppMenu> {
    ...
    public MenuOprationAdapter(Context context) {
    ...
    public void bindHolder(BaseViewHolder baseViewHolder, int i) {
        ...
        if (item.isRead()) {
            baseViewHolder.itemView.setOnClickListener(new View.OnClickListener() { // from class: com.yd.electricecollector.menu.MenuOprationAdapter.1
                @Override // android.view.View.OnClickListener
                public void onClick(View view) {
                    if (MenuOprationAdapter.this.getItemClickListener() == null) {
                        return;
                    }
                    MenuOprationAdapter.this.getItemClickListener().onItemClicked(item);
                }
            });
        } else {
