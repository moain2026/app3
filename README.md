...
## 🤖 للوكلاء (AI Agents) — اقرأ هذا أولاً
إن كنت وكيل ذكاء اصطناعي تعمل على هذا المشروع، فابدأ إلزامياً من
**[`AGENTS.md`](./AGENTS.md)** — ملف التوجيه الرئيسي. ثم راجع
[`AGENT_CONTEXT/`](./AGENT_CONTEXT/README.md) (الذاكرة الحيّة: قرارات، مشاكل،
سجل الجلسات) لمعرفة نقطة الاستئناف.
