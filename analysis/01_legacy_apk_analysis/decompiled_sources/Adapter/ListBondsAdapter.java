...
public class ListBondsAdapter extends BaseViewAdapter<ItemBonds> {
    ...
    public class ListBondsViewHolder extends BaseViewHolder<ItemBonds> implements View.OnCreateContextMenuListener {
        ...
        public ListBondsViewHolder(int i, ViewGroup viewGroup) {
            super(i, viewGroup);
            this.onMenuItemClickListener = new MenuItem.OnMenuItemClickListener() { // from class: com.yd.electricecollector.Adapter.ListBondsAdapter.ListBondsViewHolder.1
                @Override // android.view.MenuItem.OnMenuItemClickListener
                public boolean onMenuItemClick(MenuItem menuItem) {
                    if (ListBondsAdapter.this.onContextMenuItemClickCallback == null) {
                        return true;
                    }
                    ListBondsAdapter.this.onContextMenuItemClickCallback.onContextMenuItemClick(menuItem, ListBondsViewHolder.this.getAdapterPosition());
                    return true;
                }
            };
        ...
        public void bindView(ItemBonds itemBonds) {
            Log.d(ListBondsAdapter.this.TAG, "bindView");
        ...
        public int getItemPosation() {
            return ListBondsAdapter.this.posation;
        }

        @Override // android.view.View.OnCreateContextMenuListener
        public void onCreateContextMenu(ContextMenu contextMenu, View view, ContextMenu.ContextMenuInfo contextMenuInfo) {
            if (ListBondsAdapter.this.onCreateContextMenuCallback != null) {
                ListBondsAdapter.this.onCreateContextMenuCallback.onCreateContextMenu(contextMenu, view, contextMenuInfo, getAdapterPosition(), this.onMenuItemClickListener);
            }
        }

        public void setItemPosation(int i) {
            ListBondsAdapter.this.posation = i;
        }
    }
    ...
    public void bindHolder(BaseViewHolder baseViewHolder, final int i) {
        ...
        baseViewHolder.itemView.setOnClickListener(new View.OnClickListener() { // from class: com.yd.electricecollector.Adapter.ListBondsAdapter.1
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                if (ListBondsAdapter.this.getItemClickListener() == null) {
                    return;
                }
                ListBondsAdapter.this.getItemClickListener().onItemClicked(item, i);
            }
        });
        getItemCount();
    }
